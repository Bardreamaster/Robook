...
![航模中的无刷电调](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222141657.png)
...
![20230222141728](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222141728.png)
...
![20230222141755](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222141755.png)

1. 右手螺旋定则（即安培定则）  
    用于判断通电线圈判断极性：用右手握螺线管，让四指弯向螺线管中电流方向，大拇指所指的那端就是螺线管的N极。直线电流的磁场的话，大拇指指向电流方向，另外四指弯曲指的方向为磁感线的方向。

![20230222141806](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222141806.png)

1. PWM（脉冲宽度调制）

![20230222141814](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222141814.png) 不同占空比的PWM波形
...
![20230222141822](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222141822.png)

对于简化的无刷电机来说，以三相二极内转子电机为例，定子的三相绕组有星形联结方式和三角联结方式，而三相星形联结的二二导通方式最为常用，这里就用该模型来做个简单分析：

![20230222141830](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222141830.png)

如上图所示，无刷电机三相的连接方式是每一相引出导线的一头，而另一头和其他相两两相连。这个情况下假如我们对A、B极分别施加正电压和负电压，那么由右手螺旋定则可以判断出线圈磁极的方向如下图：

![20230222141839](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222141839.png)
...
![20230222141859](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222141859.png)

然后BC相通电：

![20230222141909](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222141909.png)

...

以此类推，可以得到每个通电状态下转子的角度，就是下图中的6个状态，每个状态相隔60度，6个过程即完成了完整的转动，共进行了6次换相：

![20230222141919](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222141919.png)

整个过程就好像骑在毛驴上吊一根胡萝卜一样，旋转的磁场牵引着永磁体不断旋转：

![20230222141927](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222141927.png)
...
![20230222141937](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222141937.png)
...
![20230222141946](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222141946.png)
...
![20230222142007](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222142007.png)
...
![20230222142015](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222142015.png) 三相逆变驱动电路
...
![20230222142025](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222142025.png)
...
![20230222142046](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222142046.png)
...
![20230222142104](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222142104.png)
...
![20230222142124](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222142124.png)
...
![20230222142155](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222142155.png)
...
![20230222142208](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222142208.png)
...
![20230222142217](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222142217.png) Park变换前后的波形
...
![20230222142224](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222142224.png) PID电流环
...
![20230222142233](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222142233.png)
...
![20230222142245](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222142245.png)FOC的控制目标

通过PID控制器使用上述输入（电流采样值、编码器位置）和输出（MOS管开关状态）完成对电机电流的闭环控制。

然后进入到下一层的速度环：

![20230222142253](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222142253.png)  速度-电流双环控制
...
![20230222142302](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222142302.png) 位置-速度-电流三环控制
...
![20230222142311](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222142311.png) 位置-电流双闭环控制
...
![20230222142324](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222142324.png)

此时等效电路如图：

![20230222142331](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222142331.png)
...
![20230222142339](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222142339.png)
...
![20230222142351](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222142351.png)

如前文分析，此时的电压矢量为AO方向，大小为 U\_\{dc\} ，我们把这个矢量画在坐标轴中如图：

![20230222142359](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222142359.png) ABC坐标系和αβ坐标系下的矢量表示
...
![20230222142416](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222142416.png)
...
![20230222142428](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222142428.png)
...
![20230222142456](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222142456.png)
...
![20230222142505](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222142505.png)
MIT Mini Cheetah四足机器人

又比如，因为可以做到力矩的精确控制，我们可以用FOC驱动器配合无刷电机来实现各种力回馈装置，这就好像iPhone的Haptic Engine一样，可以模拟出各种以假乱真的物理效果：

![20230222142522](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222142522.png)
  罗技的力回馈方向盘

最后顺便提一下，我最近也在设计一个FOC矢量驱动器，熟悉我的同学应该知道我做东西的风格就是--唯小不破，因此这次也是准备设计一个超迷你的高性能FOC驱动器。硬件已经基本完工了，电路设计如下图，分为上下叠板设计，将逻辑单元和功率单元分开：

![20230222142532](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222142532.png) 逻辑控制板
![20230222142545](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222142545.png) 功率输出板

最后组装起来是这样的：

![20230222142553](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222142553.png)

同时我也给驱动器设计了个外壳（毕竟颜值就是正义啊~）：

![20230222142600](https://robook-1313535466.cos.ap-guangzhou.myqcloud.com/20230222142600.png)
